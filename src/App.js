...
import Amenities from "./component/amanities";
import Contact from "./component/contact";
import AddProperties from "./component/properties-info";
...
function App() {
  ...
  return (
    <Page>
      ...
      <Description title="Про сосудів" children={data.neighborhood_info} />
      <Amenities
        pool={data.amenities.hasPool}
        gym={data.amenities.hasGym}
        breakfest={data.amenities.hasFreeBreakfast}
        wifi={data.amenities.hasFreeWiFi}
        parking={data.amenities.hasParking}
        pups={data.amenities.hasPetsAllowed}
        transfer={data.amenities.hasAirportShuttle}
        security={data.amenities.hasConciergeService}
        cleaning={data.amenities.hasRoomService}
        children={data.amenities.hasChildFriendly}
      />
      <Contact
        name={data.contact_info.name}
        src={data.contact_info.image}
      ...
      <AddProperties
        ...
        offers={data.additional_properties.host_languages}
        check={data.additional_properties.check_in_instructions}
      />
      <Reviews list={data.guestReviews} />
      <Trip list={data.nearbyAttractions} />
    </Page>
  );
}
